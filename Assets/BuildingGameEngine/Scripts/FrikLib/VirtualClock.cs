...
namespace FrikLib
{
    ...
    public class VirtualClock : System.Object
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            if (obj is VirtualClock)
            {
                //objがVirtualClock型であることの保証ができたためasキャストし、比較
                VirtualClock objAsVc = obj as VirtualClock;
                return (year == objAsVc.year) && (month == objAsVc.month) && (day == objAsVc.day)
                    && (hour == objAsVc.hour) && (minute == objAsVc.minute) && (second == objAsVc.second);
            }
            else
            {
                //objがVirtualClock型でないため偽
                return false;
            }
        }
