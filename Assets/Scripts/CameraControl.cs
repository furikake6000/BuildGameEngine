...
public class CameraControl : MonoBehaviour, IDragHandler {
    ...
    const float MouseWheelFix = 5.0f;
	...
	void Update () {
        ...
        {
            Zoom( - Input.GetAxis("Mouse ScrollWheel") * MouseWheelFix * zoomRate);
        }
    }
                ...
                else if (Input.touchCount == 2)
                {
                    ...
                    if (t2.phase != TouchPhase.Began)
                    {
                        ...
                        if (t1.phase != TouchPhase.Began && t2.phase != TouchPhase.Began)
                        {
                            ...
                            //拡大
                            Zoom(deltaDist * zoomRate / pixelPerCm);
                        }
                    }
                    pastTouch[0] = t1;
                    pastTouch[1] = t2;
    ...
    {
        //拡大
        Camera.main.orthographicSize += rate;
        //最大最小値と照らし合わせる
